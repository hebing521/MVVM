...
import test.mvvm.BR;
import test.mvvm.R;
import test.mvvm.base.BaseViewHolder;
import test.mvvm.bean.BaseAdapter;
 ...
 * Created Time By 下午 5:21
 * Provide Content By MVVM
 * Created by HeBing
 * Provide Content By test.mvvm.adapter
 */
